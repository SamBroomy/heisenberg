...
//!
//! ```rust
//! use heisenberg_geo::LocationSearcher;
//!
...
//! # Ok::<() , heisenberg_geo::error::HeisenbergError>(())
//! ```
//!
//! # Search Types
//!
...
/// ```rust
/// use heisenberg_geo::{LocationSearcher, SearchConfig};
///
...
impl LocationSearcher {
    ...
    ///
    /// ```rust
    /// use heisenberg_geo::{DataSource, LocationSearcher};
    ///
    ...
    ///
    /// ```rust
    /// use heisenberg_geo::{DataSource, LocationSearchData, LocationSearchIndex, LocationSearcher};
    ///
    ...
    ///
    /// ```rust
    /// use heisenberg_geo::{AdminSearchParams, LocationSearcher};
    ///
    /// let searcher = LocationSearcher::new_embedded()?;
    ///
    ...
    ///
    /// ```rust
    /// use heisenberg_geo::{LocationSearcher, PlaceSearchParams};
    ///
    /// let searcher = LocationSearcher::new_embedded()?;
    ...
    ///
    /// ```rust
    /// # use heisenberg_geo::{LocationSearcher, ResolveSearchConfig};
    /// # let searcher = LocationSearcher::new_embedded().unwrap();
