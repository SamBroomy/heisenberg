...
def main():
    ...
    if results:
        print(f"  Top result: {results[0].name} (Score: {results[0].score:.3f})")
        print(f"  This should prefer Cambridge, UK over Cambridge, MA")
    print()
    ...
    if results:
        print(f"  Top result: {results[0].name} (Score: {results[0].score:.3f})")
        print(f"  This should prefer Cambridge, MA over Cambridge, UK")
    print()
    ...
    try:
        ...
        invalid_options = heisenberg.SearchOptions(
