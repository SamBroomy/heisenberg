...
from ._heisenberg_geo_rust_bindings import DataSource as RustDataSource
from ._heisenberg_geo_rust_bindings import (
    LocationContext,
    LocationEntry,
    ResolvedSearchResult,
    __version__,
)
from ._heisenberg_geo_rust_bindings import LocationSearcher as RustLocationSearcher
from ._heisenberg_geo_rust_bindings import (
    LocationSearcherBuilder as RustLocationSearcherBuilder,
)
from ._heisenberg_geo_rust_bindings import SearchConfig as RustSearchConfig
from ._heisenberg_geo_rust_bindings import (
...
class LocationSearcher:
    ...
    def __init__(
        self, data_source: DataSource | None = None, *, rebuild_indexes: bool = False
    ) -> None:
    ...
    def find(
        self, query: str | list[str], config: SearchOptions | None = None
    ) -> list[SearchResult]:
    ...
    def find_batch(
        self, queries: list[list[str]], config: SearchOptions | None = None
    ...
    def place_search(
        self, term: str, previous_result: pl.DataFrame | None = None
    ) -> pl.DataFrame | None:
        """Search for places.
